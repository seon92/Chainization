...
def parse_option():
    ...
    parser.add_argument('--info_ratio', type=int, default=0.0003, help='information ratio')
    ...
    parser.add_argument('--train_file', type=str, default='/hdd/2021/Research/4_OL/partially_ordered_data_OL/data/Adience/adience_F%d_train_algn_[0_7].pickle', help='path to train file')
    parser.add_argument('--test_file', type=str, default='/hdd/2021/Research/4_OL/partially_ordered_data_OL/data/Adience/adience_F%d_test_algn_[0_7].pickle', help='path to test file')
    ...
    opt.tau_multiplier = 4
    opt.model_name = 'm{}_{}_{}_lr_{}_F{}_IR{}_{}'.format(opt.tau_multiplier, opt.backbone, opt.model, opt.learning_rate, opt.fold, opt.info_ratio, get_current_time())
    ...
    for epoch in range(opt.epochs):
        ...
        if train_acc > 90 and (chainize_flag1 or chainize_flag2):
            ...
            generated_pair_list, pseudo_labels = generate_training_pairs_from_chain(chain_info,
                                                                                    ...
                                                                                    train_data.n_imgs,
                                                                                    min_distance=int(np.ceil(len(chain_info)/8)*opt.tau_multiplier), max_num=100)
